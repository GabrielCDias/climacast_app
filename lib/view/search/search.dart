...
import 'package:climacast_app/view/search/widgets/loading_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Procurar', style: whiteTxt22),
        centerTitle: true,
        backgroundColor: blackColor,
        elevation: 0,
      ),
              ...
              GetBuilder<WeatherController>(
                  ...
                  builder: (controller) {
                    if (controller.isLoading) {
                      ...
                      return const Text('Lugar não encontrado.',
                          style: whiteTxt20);
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                'País : ${controller.weatherData.city!.country!}',
                                style: white38Txt14,
                              )
                            ],
                          ),
